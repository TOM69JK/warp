...
(async () => {
	...
	const Panel = {
		...
		"content": `${Configs.i18n[Language].IPv4}:💧${Trace4?.ip}💧\n`
			...
			+ `${Configs.i18n[Language].WARP_Level}:🌩️${Trace4?.warp ?? Trace6?.warp}🌩️\n`
			+ `${Configs.i18n[Language].Account_Type}:⛈️${Account?.data?.type ?? Configs.i18n[Language].Fail}⛈️\n`
			+ `${Configs.i18n[Language].Data_Info}:🌨️${Account?.data?.text ?? Configs.i18n[Language].Fail}🌨️`,
	};
    $done(Panel);
})()
	.catch((e) => $.logErr(e))
